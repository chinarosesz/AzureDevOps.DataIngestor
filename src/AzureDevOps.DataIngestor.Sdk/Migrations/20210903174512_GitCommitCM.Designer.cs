...
namespace AzureDevOps.DataIngestor.Sdk.Migrations
{
    ...
    [Migration("20210903174512_GitCommitCM")]
    partial class GitCommitCM
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureDevOps.DataIngestor.Sdk.Entities.VssCommitEntity", b =>
                {
                    ...
                    b.HasKey("CommitId", "RepositoryId");

                    b.ToTable("VssCommit");
                });

            modelBuilder.Entity("AzureDevOps.DataIngestor.Sdk.Entities.VssCommitWatermarkEntity", b =>
                {
                    b.Property<Guid>("RepositoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
